...
export class DetailView {
  ...
  open(tile) {
    ...
    // End target — the hero at its own native aspect ratio (no crop); see
    // heroLayout.js. z stays 0 so world units equal CSS pixels exactly,
    // which ProjectPage relies on to hand off to a pixel-identical DOM
    // element with no pop.
